  ...
  constructor(
    ...
    this.combinedSub = combineLatest([
      ...
      switchMap(([countries,
        ...
        this.famformSer.setFilter(familyAll.unique_display_no)
        let famform$ = this.famformSer.getWithQueryByFamEstFormDataUDNUnlessLoaded(familyAll.unique_display_no).pipe(tap(x=> console.log('echo', x)))
